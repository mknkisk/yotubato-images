 ...
 *
 */
function(){"use strict";function t(){i.classList.remove("open"),o.classList.remove("open"),r.classList.remove("open")}function e(){i.classList.toggle("open"),o.classList.toggle("open"),r.classList.toggle("open"),r.classList.add("opened")}var n=document.querySelector.bind(document),r=n(".navdrawer-container"),i=document.body,o=n(".app-bar"),a=n(".menu"),s=n("main");s.addEventListener("click",t),a.addEventListener("click",e),r.addEventListener("click",function(e){("A"===e.target.nodeName||"LI"===e.target.nodeName)&&t()})}();